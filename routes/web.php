...
Route::post('users/carts', 'CartControler@store')->name('carts.store');
...
Route::get('users/mypage/favorite', 'UserController@favorite')->name('mypage.favirite');
Route::get('users/mypage/password', 'UserController@edit_password')->name('mypage.edit_password');
